                    ...
                    <div className='max-w-7xl mx-auto'>
                        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2'>
                            <div className='mb-5'>
                                ...
                                <p className='text-gray-500 hover:text-blue-200  pb-4'>24/7 Mohammadpur, Dhaka
                                    <br /> <br />
                ...
                <div className='w-full bg-gray-900 text-gray-500 px-10'>
                    <div className='max-w-7xl flex flex-col sm:flex-row py-4 mx-auto justify-between items-center'>
                        ...
                        <div className='text-center text-xl text-white mb-2'>
                            ...
                            <span className="w-10 h-10 rounded-full bg-blue-900 hover:bg-rose-900 mx-1 inline-block pt-1" ><i className="fab fa-facebook"></i></span>
                            <span className="w-10 h-10 rounded-full bg-blue-900 hover:bg-rose-900 mx-1 inline-block pt-1" ><i className="fab fa-linkedin"></i></span>
                            <span className="w-10 h-10 rounded-full bg-blue-900 hover:bg-rose-900 mx-1 inline-block pt-1" ><i className="fab fa-twitter"></i></span>
                            <span className="w-10 h-10 rounded-full bg-blue-900 hover:bg-rose-900 mx-1 inline-block pt-1" ><i className="fab fa-instagram"></i></span>
