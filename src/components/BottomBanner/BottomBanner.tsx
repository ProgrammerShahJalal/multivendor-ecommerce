				...
				<section style={{ margin: '50px' }} className="shop-services section home">
					<div className="container">
						<div className="grid md:grid-cols-2 grid-cols-1 lg:grid-cols-4 ">
							<div className="bg-white dark:bg-slate-800 dark:bg-slate-800 per-service shadow-lg mx-3">
							...
							<div className="bg-white dark:bg-slate-800 dark:bg-slate-800 shadow-lg per-service mx-3">
