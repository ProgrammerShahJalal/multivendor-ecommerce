                    ...
                    <table className="min-w-full leading-normal">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <p className="text-white rounded whitespace-no-wrap text-left bg-red-500 p-2 ">
                                        Delete
                                    </p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <p className="text-gray-900 whitespace-no-wrap text-left">Laptop</p>
                                </td>
                                <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <p className="text-gray-900 whitespace-no-wrap text-left">300.00tk</p>
                                </td>
                            ...
                            <tr>
                                ...
                                <td className="px-5 py-5 bg-white text-sm text-left">
                                    <span
                                        ...
                                        <span className="relative text-left">Cancelled</span>
                                    </span>
                                </td>
                                <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <p className="text-white rounded whitespace-no-wrap text-left bg-red-500 p-2 ">
