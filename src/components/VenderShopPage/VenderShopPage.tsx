...
export default function VendorShopPage() {
    ...
    useEffect(() => {
        ...
        fetch(`http://localhost:5000/user/vendors/products/${storeSlug}`)
            .then(res => res.json())
            .then(data => {
                setProducts(data)
            })
            ...
            <div className='min-h-screen lg:flex md:flex-1 '>
                ...
                <div>
                    ...
                    <div className='grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-10 py-5 '>
                        ...
                        {products?.length === 0 ? <h2>No Products Found</h2> : products?.map((product: any) => (<div className=' shadow-lg rounded-md w-border '>
