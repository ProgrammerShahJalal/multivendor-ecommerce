...
export default function DetailedOrder() {
    ...
    const trackOrderFunc = (e) => {
        e.preventDefault()
        TrackOrderApi(id, email, setData, setIsLoading)
    }
    console.log(data);
    ...
    return (
        <div>
            ...
            <div className=''>
                ...
                <form onSubmit={trackOrderFunc}>
                    <div>
                        <form className='flex flex-col space-y-4 text-left w-6/12 mx-auto pb-10'>
                            <div>
                                <label htmlFor="" className='text-lg'>Order ID</label>

                                <input onBlur={(e: any) => setId(e.target.value)} type="number" placeholder='Find in your order confirmation email.' className='ring-1 ring-gray-300 w-full rounded-md px-4 py-4 mt-2  outline-none focus:ring-2 focus:ring-teal-300 ' />
                            </div>
                            <div>
                                <label className='text-lg'>Your Billing Email</label>

                                <input onBlur={(e: any) => setEmail(e.target.value)} type="email" placeholder='Email you used during checkout.' className='ring-1 ring-gray-300 w-full rounded-md px-4 py-4 mt-2 outline-none focus:ring-2 focus:ring-teal-300 ' />
                            </div>
