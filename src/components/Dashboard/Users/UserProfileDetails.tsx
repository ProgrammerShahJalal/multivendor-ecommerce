                                    ...
                                    <div className="text-gray-700 text-left">
                                        <div className="grid md:grid-cols-2 text-sm">
                                            <div className="grid grid-cols-2">
                                                ...
                                                <div className="px-4 py-2">{vendor.firstName}</div>
                                            </div>
                                            <div className="grid grid-cols-2">
                                                <div className="px-4 py-2 font-semibold">Last Name</div>
                                                <div className="px-4 py-2">{vendor.lastName}</div>
                                            </div>
                                            {/* <div className="grid grid-cols-2">
                                            ...
                                            <div className="grid grid-cols-2">
                                                ...
                                                <div className="px-4 py-2">{vendor.supportPhoneNumber}</div>
                                            </div>
                                            <div className="grid grid-cols-2">
                                                <div className="px-4 py-2 font-semibold">Current Address</div>
                                                <div className="px-4 py-2">{vendor.city}, {vendor.country}</div>
                                            </div>
                                            <div className="grid grid-cols-2">
                                            ...
                                            <div className="grid grid-cols-2">
                                                ...
                                                <div className="px-4 py-2">
                                                    <a className="text-blue-800" href="mailto:jane@example.com">{vendor.supportEmail}</a>
                                                </div>
                                            </div>
                                            {/* <div className="grid grid-cols-2">
