                                ...
                                <div className="bg-white dark:bg-slate-800 p-3 border-t-4 border-indigo-600">
                                    <div className="image overflow-hidden">
                                        ...
                                        {isTrue ? <img className="h-auto w-full mx-auto"
                                            ...
                                            <input type="url" defaultValue={vendor.photo} name="photo" onBlur={handleGetFieldValues} className="my-2 bg-purple-white shadow rounded border-1 border-neutral-300 p-3" placeholder="Photo url..." /></>}
                                    </div>
                                    <h1 className="text-gray-900 dark:text-white font-bold text-xl leading-8 my-1">{vendor.name}</h1>
                                    ...
                                    <ul
                                        ...
                                        <li className="flex items-center py-3">
                                            ...
                                            <span className="ml-auto"><span
                                                className={`${vendor.role === "user" ? "bg-green-600 py-1 px-2 rounded text-white text-sm" : "bg-red-600 py-1 px-2 rounded text-white text-sm"} `}>{vendor.role}</span></span>
                                        </li>
                                        <li className="flex items-center py-3">
                                            <span>Member since</span>
                                            <span className="ml-auto">{vendor.date.split(",")[0]}</span>
                                        </li>
                                    </ul>
                                </div>
                                {isTrue ? <button onClick={() => setIsTrue(!isTrue)} type="submit" className="inline-flex justify-center w-full mt-4 py-2 px-4 border border-transparent drop-shadow-md text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Edit</button> : <button onClick={() => updateProfile(vendor.email)} type="submit" className="inline-flex justify-center w-full mt-4 py-2 px-4 border border-transparent drop-shadow-md text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Save</button>}
                                {/* <!-- End of profile card -->  */}

                                <button onClick={() => updateRole(vendor.email, "admin")} type="submit" className="inline-flex justify-center w-full mt-4 py-2 px-4 border border-transparent drop-shadow-md text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">Make Admin</button>
                                <button onClick={() => updateRole(vendor.email, "user")} type="submit" className="inline-flex justify-center w-full mt-4 py-2 px-4 border border-transparent drop-shadow-md text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">Make User</button>
                                {/*<button onClick={() => updateStatus(vendor.storeEmail, "Deactivate")} type="submit" className="inline-flex justify-center w-full mt-4 py-2 px-4 border border-transparent drop-shadow-md text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Make user</button> */}
                                    ...
                                    <div className="text-gray-700 text-left">
                                        <div className="grid md:grid-cols-2 text-sm">
                                            <div className="grid grid-cols-2">
                                                ...
                                                {isTrue ? <div className="px-4 py-2">{vendor.name}</div> :
                                                    <input name="firstName" onBlur={handleGetFieldValues} type="text" defaultValue={vendor.name} className="my-2 bg-purple-white shadow rounded border-1 border-neutral-300 p-3" placeholder="Search by name..." />}
                                            </div>
                                            <div className="grid grid-cols-2">
                                            ...
                                            <div className="grid grid-cols-2">
                                                ...
                                                {isTrue ? <div className="px-4 py-2">{vendor.phone}</div> :
                                                    <input name="phone" onBlur={handleGetFieldValues} type="text" defaultValue={vendor.phone} className="bg-purple-white shadow rounded border-1 border-neutral-300 p-3" placeholder="Search by name..." />}
                                            </div>
                                            <div className="grid grid-cols-2">
                                            ...
                                            <div className="grid grid-cols-2">
                                                <div className="px-4 py-2 font-semibold">Zip</div>
