...
const About = () => {
    return (
        <div className='container mx-auto'>
            <h1 className='text-4xl font-bold py-3 bg-gray-600  hover:bg-sky-700 '>About Us</h1>
            ...
            <div className='container pt-3'>
                <div className='grid grid-cols-2 gap-0 items-center justify-center'>
                    ...
                    <div className='w-50 px-5'>
                        ...
                        <button className="mt-2 text-white bg-purple-600 px-3 justify-center py-1 rounded-md hover:bg-purple-800 transition">Read More</button>
                    </div>
                </div>
            </div>
            <div className='container mx-auto'>
