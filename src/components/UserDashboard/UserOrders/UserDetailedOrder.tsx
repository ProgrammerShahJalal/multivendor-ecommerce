...
import { CancelOrder } from "../../../Services/orderApi/CancelOrderApi";

export default function UserDetailedOrder() {
    const { id } = useParams()
    ...
    const CancelOrderFunc = (id) => {
        if (window.confirm('Are you sure your to cancel the order')) {
            CancelOrder(id, setIsLoading, navigate)
        }
