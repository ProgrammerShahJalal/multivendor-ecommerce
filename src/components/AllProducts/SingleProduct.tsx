                                    ...
                                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                        <div>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                                ...
                                                <button onClick={() => dispatch((addToWishlist(detailProduct)))} className="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-red-500 ml-4">
