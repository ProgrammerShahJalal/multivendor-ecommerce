      ...
      <div className="text-center grid lg:grid-cols-2 xs:grid-cols-1">
        ...
        <div className="space-y-4 text-black dark:text-white">
          <Item className='text-black dark:text-white' title={<b>How can I check my products?</b>}>
            <p className="text-gray-800 dark:text-white">Confirm that the product you have bought are from unityMart. Tilt the carton check the sticker on the carton and scan the QR code using our app.</p>
          </Item>
