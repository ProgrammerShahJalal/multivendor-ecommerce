            ...
            <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
                {
                    vendors?.map((vendor: any) => <div key={vendor?._id} className="card shadow-lg">
                        <div style={{ height: '150px', width:'350px' }} className="card-image border-b-2 border-blue-600 flex justify-center ">
                            <img className='h-full w-full object-contain' src={vendor?.storeBanner} alt="" />
                        </div>
