        ...
        <div className='container mx-auto py-4'>
            <div className='bg-black grid md:grid-cols-2 sm:grid-cols-1  p-7 my-3 items-center justify-center'>
                ...
                <div className='mt-7' data-aos="fade-up"
                    ...
                    <img src='https://e-commerce.myproyash.com/wp-content/uploads/2021/05/dualshok.png' className='w-full -mb-20 pt-7 hover:-translate-y-3 transition duration-700 ease-in-out' alt='' />
                </div>
            </div>
        </div>
    );
