        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
            {
                lists.map(list => <div key={list.id} className="card shadow-lg">
                    ...
                    <div className="content text-left pl-5">
                        ...
                        <p className='py-2 text-white font-bold text-lg text-red-500'><i className="fa-solid fa-envelope text-red-500 text-lg"></i> {list.email}</p>
                        <p className='text-white font-bold text-lg text-green-700 '><i className="fa-solid fa-phone text-green-700 text-lg"></i> {list.phone}</p>
                    </div>
