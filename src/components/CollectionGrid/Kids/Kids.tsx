...
return (
    <div className="container lg:px-0 md:px-10 px-10 pb-16">
            <div className="grid lg:grid-cols-3 md:grid-cols-2 xs:grid-cols-1 gap-6">
                ...
                <div style={{height:'250px',width:'400px'}} className='z-100 overflow-hidden'>
                                <img style={{marginLeft:'24px'}} src={product.hoverImg} className='w-full img flex items-center justify-center z-0 transition object-cover' alt="" />
                                <img style={{marginLeft:'24px'}} src={product.img} className='w-full hoverImg transition object-cover' alt="" />
                                </div>
