        ...
        return (
            <div className="grid grid-cols-3 my-7">
                <div className="lg:col-span-2 col-span-3 bg-indigo-50 space-y-8 px-12">
                    <div className="mt-8 p-4 relative flex flex-col sm:flex-row sm:items-center bg-white dark:bg-slate-800 shadow rounded-md ">
                        ...
                        <div className="absolute sm:relative sm:top-auto sm:right-auto ml-auto right-4 top-4 text-gray-400 hover:text-gray-800 dark:text-white cursor-pointer">
                    ...
                    <div className="rounded-md">
                        <form id="payment-form" method="POST" action="">
                            <div>
                                ...
                                <fieldset className="mb-3 bg-white dark:bg-slate-800 shadow-lg rounded text-gray-600">
                ...
                <div className="col-span-1 bg-white dark:bg-slate-800 lg:block hidden">
