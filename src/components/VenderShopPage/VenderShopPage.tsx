        ...
        <div className="bg-gray-200 dark:bg-gray-800 px-8">
            ...
            <div className='min-h-screen lg:flex md:flex-1 gap-5'>
                ...
                <div className='w-4/5'>
                    ...
                    <div className='grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-5 py-5'>

                        {products?.length > 0 && products?.map((product: any) => (<div className=' shadow-lg rounded-xl w-border '>

                            <div className='w-60 mx-auto px-8 bg-white'>
