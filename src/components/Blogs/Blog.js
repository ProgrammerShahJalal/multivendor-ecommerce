                ...
                <div className="max-w-md mx-auto bg-white dark:bg-slate-800 rounded-xl shadow-md overflow-hidden md:max-w-2xl">
                    <div className="md:flex">
                        ...
                        <div className="p-8">
                            ...
                            <Link to={`/blogs/details/${_id}`} className="block mt-1 text-lg leading-tight font-medium text-gray-800 dark:text-white hover:underline truncate w-96">{title}</Link>
