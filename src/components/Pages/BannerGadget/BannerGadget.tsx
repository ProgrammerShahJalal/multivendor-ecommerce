                ...
                <div className='grid md:grid-cols-2 sm:grid-cols-1 '>
                    <div className='relative'>
                        ...
                        <div className='absolute inset-y-8 left-5 w-72 py-2'>
                            ...
                            <h1 className="lg:text-4xl text-gray-800 dark:text-white dark:text-white font-bold hover:text-pink-600 py-3 sm:text-sm">WEBCAMS 2022</h1>
                    ...
                    <div className='relative'>
                        ...
                        <div className='absolute inset-y-8 left-5 w-72 py-1'>
                            ...
                            <h1 className="lg:text-4xl text-white font-bold hover:text-gray-800 dark:text-white dark:text-white py-3 sm:text-sm">LEATHER CASES</h1>
                            ...
                            <Link to="/shop">
                                <button className='bg-white dark:bg-slate-800 text-gray-800 dark:text-white dark:text-white px-3 py-2 pb-1 rounded-full hover:bg-pink-500 font-bold lg:block hidden'>SHOP MORE</button>
                            </Link>
                        </div>
                    </div>
                </div>
