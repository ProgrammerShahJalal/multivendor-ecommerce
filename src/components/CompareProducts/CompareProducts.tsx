              ...
              <table className="table-auto">
                <thead className="bg-white border-b">
                  <tr>
                    <td className='border p-5'>
                      ...
                      <img className="w-32 mx-auto" src="https://i.ibb.co/YZ22rRz/s-l500.jpg" alt="logo" />
                ...
                <tbody>
                  ...
                  <tr className='bg-white border'>
                    ...
                    <td className="text-lg border-r"><p className="text-red-500">In stock</p></td>
                    <td className=" text-lg py-3"><p className="text-red-500">In stock</p></td>
                  </tr>

                  <tr className='bg-white border '>
                    <td className=""><a className="bg-gradient-to-r from-purple-500 to-pink-500 uppercase p-3 text-white hover:bg-black" href="cart.html">Add to Cart</a></td>
                    <td className=""><a className="bg-gradient-to-r from-purple-500 to-pink-500 uppercase p-3 text-white hover:bg-black" href="cart.html">Add to Cart</a></td>
                    <td className=""><a className="bg-gradient-to-r from-purple-500 to-pink-500 uppercase p-3 text-white hover:bg-black" href="cart.html">Add to Cart</a></td>
                  </tr>
                </tbody>
