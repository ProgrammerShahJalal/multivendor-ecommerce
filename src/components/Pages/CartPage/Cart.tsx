                                        ...
                                        cart.map(item => {
                                            return <tr>
                                                <td className="hidden pb-4 md:table-cell">
                                                    ...
                                                    <img src={item.images[0]?.src} className="w-20 rounded" alt="Thumbnail" />
                                                ...
                                                <td className="hidden text-right md:table-cell">
                                                    <span className="text-sm lg:text-base font-medium">
                                                        ${item.sale_price ? item.sale_price : item.reg_price}
                                                    </span>
                                                </td>
                                                <td className="text-right">
                                                    <span className="text-sm lg:text-base font-medium">
                                                        ${item.sale_price ? item.sale_price * item.cartQuantity : item.reg_price * item.cartQuantity}
                                                    </span>
                                                </td>
                                            </tr>
                                        })
