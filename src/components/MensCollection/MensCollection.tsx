                    ...
                    products.map((product) => (
                        <div className="bg-white dark:bg-slate-600 shadow-inner overflow-hidden single-card">
                            ...
                            <Link to={`/productDetails/men/${product._id}`}>
                                <button className='block w-full py-1 text-center top-5 text-white bg-indigo-500 border border-indigo-500 hover:bg-transparent hover:text-indigo-500 transition'>View Product</button>
                            </Link>
                        </div>
                    ))}
            </div>
