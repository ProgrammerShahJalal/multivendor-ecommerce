...
export default function Navbar() {
    ...
    return (
        <Disclosure as="nav" className="bg-gradient-to-r from-indigo-500 via-purple-500 to-green-400">
            {({ open }) => (
                <>
                        ...
                        <div className="relative flex items-center justify-between h-16">
                            ...
                            <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                                <div className="flex-shrink-0 flex items-center">
                                    <h2 className="block lg:hidden h-8 w-auto text-white text-2xl"><Link to="/">Unity Mart</Link></h2>
                                    <h2 className="hidden lg:block h-8 w-auto text-white text-2xl"><Link to="/">Unity Mart</Link></h2>
                                </div>
